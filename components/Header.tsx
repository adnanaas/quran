  ...
  return (
    <header className="sticky top-0 z-50 bg-emerald-800 text-white shadow-md p-4 flex items-center justify-between">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold font-['Noto Sans Arabic']">{title}</h1>
      </div>
      <div className="bg-emerald-900/50 p-2 rounded-lg">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-emerald-200">
